...
int main()
{
    ...
    play_sample(sound, 30, 127, 1000, true);     //Odtwarza dzwiêk o podanej g³oœnoœci podziale na g³oœniki i ile razy w pêtli
    ...
    while(!key[KEY_ESC])
    {
        ...
        install_int_ex( increment_speed1, MSEC_TO_TIMER( 70 ) );
        install_int_ex( increment_speed2, MSEC_TO_TIMER( 500 ) );
