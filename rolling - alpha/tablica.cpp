...
void Tablica::gra()         //Wybór kszta³tów
{
    ...
    if(losowanie==1)
    {
        if(obrot1 == false)
        {
            ...
            tmp_rysowanie=_I_0_;
            masked_blit( tmp_rysowanie, screen, 0, 0, x, y, tmp_rysowanie->w, tmp_rysowanie->h );
            poruszanie(_I_0_DELETE,_I_0_);
            if(y>tmp_y || f_I_0_D==true)
            {
    ...
    if(losowanie==2)
    {
        if(obrot2_0 == false && obrot2_1 == false && obrot2_2 == false)
        {
            if(f_uzupelnienie==false)
            {
                __T__(x,y);
        ...
        if(key[KEY_4])
        {
            ...
            if(obrot2_0 == false && obrot2_1 == false && obrot2_2 == false)
                __T__DELETE(x,y);
            if(obrot2_0 == false && obrot2_1 == true && obrot2_2 == false)
                __T_2_DELETE(x,y);
            if(obrot2_0 == false && obrot2_1 == false && obrot2_2 == true)
                __T_3_DELETE(x,y);
            masked_blit( tmp_czyszczenie, screen, 0, 0, x, y, tmp_czyszczenie->w, tmp_czyszczenie->h );
            tmp_czyszczenie=_T_1_DELETE;
            tmp_rysowanie=_T_1_;
            masked_blit( tmp_rysowanie, screen, 0, 0, x, y, tmp_rysowanie->w, tmp_rysowanie->h );
            if(f_uzupelnienie==false)
            {
        ...
        if(key[KEY_2])
        {
            ...
            if(obrot2_0 == false && obrot2_1 == false && obrot2_2 == false)
                __T__DELETE(x,y);
            if(obrot2_0 == true && obrot2_1 == false && obrot2_2 == false)
                __T_1_DELETE(x,y);
            if(obrot2_0 == false && obrot2_1 == false && obrot2_2 == true)
                __T_3_DELETE(x,y);
            masked_blit( tmp_czyszczenie, screen, 0, 0, x, y, tmp_czyszczenie->w, tmp_czyszczenie->h );
            tmp_czyszczenie=_T_2_DELETE;
            tmp_rysowanie=_T_2_;
            masked_blit( tmp_rysowanie, screen, 0, 0, x, y, tmp_rysowanie->w, tmp_rysowanie->h );
            if(f_uzupelnienie==false)
            {
        ...
        if(obrot2_0 == true && obrot2_1 == false && obrot2_2 == false)
        {
            poruszanie1(_T_1_DELETE,_T_1_);
        }
        if(obrot2_0 == false && obrot2_1 == true && obrot2_2 == false)
        {
            poruszanie1(_T_2_DELETE,_T_2_);
        }
        if(obrot2_0 == false && obrot2_1 == false && obrot2_2 == true)
        {
            poruszanie1(_T_3_DELETE,_T_3_);
        }
    }
    if(losowanie==3)
    {
        if(obrot3_0 == false && obrot3_1 == false && obrot3_2 == false)
        {
            if(f_uzupelnienie==false)
            {
                __L__(x,y);
        ...
        if(key[KEY_4])
        {
            ...
            if(obrot3_0 == false && obrot3_1 == false && obrot3_2 == false)
                __L__DELETE(x,y);
            if(obrot3_0 == false && obrot3_1 == true && obrot3_2 == false)
                __L_2_DELETE(x,y);
            if(obrot3_0 == false && obrot3_1 == false && obrot3_2 == true)
                __L_3_DELETE(x,y);
            masked_blit( tmp_czyszczenie, screen, 0, 0, x, y, tmp_czyszczenie->w, tmp_czyszczenie->h );
            tmp_czyszczenie=_L_1_DELETE;
            tmp_rysowanie=_L_1_;
            masked_blit( tmp_rysowanie, screen, 0, 0, x, y, tmp_rysowanie->w, tmp_rysowanie->h );
            if(f_uzupelnienie==false)
            {
        ...
        if(key[KEY_2])
        {
            ...
            if(obrot3_0 == false && obrot3_1 == false && obrot3_2 == false)
                __L__DELETE(x,y);
            if(obrot3_0 == true && obrot3_1 == false && obrot3_2 == false)
                __L_1_DELETE(x,y);
            if(obrot3_0 == false && obrot3_1 == false && obrot3_2 == true)
                __L_3_DELETE(x,y);
            masked_blit( tmp_czyszczenie, screen, 0, 0, x, y, tmp_czyszczenie->w, tmp_czyszczenie->h );
            tmp_czyszczenie=_L_2_DELETE;
            tmp_rysowanie=_L_2_;
            masked_blit( tmp_rysowanie, screen, 0, 0, x, y, tmp_rysowanie->w, tmp_rysowanie->h );
            if(f_uzupelnienie==false)
            {
        ...
        if(obrot3_0 == true && obrot3_1 == false && obrot3_2 == false)
        {
            poruszanie1(_L_1_DELETE,_L_1_);
        }
        if(obrot3_0 == false && obrot3_1 == true && obrot3_2 == false)
        {
            poruszanie1(_L_2_DELETE,_L_2_);
        }
        if(obrot3_0 == false && obrot3_1 == false && obrot3_2 == true)
        {
            poruszanie1(_L_3_DELETE,_L_3_);
        }
    }
    if(losowanie==4)
    {
        if(obrot4_0 == false && obrot4_1 == false && obrot4_2 == false)
        {
            if(f_uzupelnienie==false)
            {
                __J__(x,y);
        ...
        if(key[KEY_4])
        {
            ...
            if(obrot4_0 == false && obrot4_1 == false && obrot4_2 == false)
                __J__DELETE(x,y);
            if(obrot4_0 == false && obrot4_1 == true && obrot4_2 == false)
                __J_2_DELETE(x,y);
            if(obrot4_0 == false && obrot4_1 == false && obrot4_2 == true)
                __J_3_DELETE(x,y);
            masked_blit( tmp_czyszczenie, screen, 0, 0, x, y, tmp_czyszczenie->w, tmp_czyszczenie->h );
            tmp_czyszczenie=_J_1_DELETE;
            tmp_rysowanie=_J_1_;
            masked_blit( tmp_rysowanie, screen, 0, 0, x, y, tmp_rysowanie->w, tmp_rysowanie->h );
            if(f_uzupelnienie==false)
            {
        ...
        if(key[KEY_2])
        {
            ...
            if(obrot4_0 == false && obrot4_1 == false && obrot4_2 == false)
                __J__DELETE(x,y);
            if(obrot4_0 == true && obrot4_1 == false && obrot4_2 == false)
                __J_1_DELETE(x,y);
            if(obrot4_0 == false && obrot4_1 == false && obrot4_2 == true)
                __J_3_DELETE(x,y);
            masked_blit( tmp_czyszczenie, screen, 0, 0, x, y, tmp_czyszczenie->w, tmp_czyszczenie->h );
            tmp_czyszczenie=_J_2_DELETE;
            tmp_rysowanie=_J_2_;
            masked_blit( tmp_rysowanie, screen, 0, 0, x, y, tmp_rysowanie->w, tmp_rysowanie->h );
            if(f_uzupelnienie==false)
            {
        ...
        if(obrot4_0 == true && obrot4_1 == false && obrot4_2 == false)
        {
            poruszanie1(_J_1_DELETE,_J_1_);
        }
        if(obrot4_0 == false && obrot4_1 == true && obrot4_2 == false)
        {
            poruszanie1(_J_2_DELETE,_J_2_);
        }
        if(obrot4_0 == false && obrot4_1 == false && obrot4_2 == true)
        {
            poruszanie1(_J_3_DELETE,_J_3_);
        }
    }
    if(losowanie==5)
    {
...
void Tablica::poruszanie(BITMAP * tmp_czyszczenie, BITMAP * tmp_rysowanie)      //Poruszanie siê kszta³tami po planszy
{
    ...
    if(key[ KEY_RIGHT ])
    {
        ...
        if(x<=tmp_x_R && (   (losowanie==1 && f_I_0_P==false) || (losowanie==2 && f_T_0_P==false) || (losowanie==3 && f_L_0_P==false) || (losowanie==4 && f_J_0_P==false) || (losowanie==5 && f_O_P==false) || (losowanie==6 && f_S_0_P==false) || (losowanie==7 && f_Z_0_P==false)   ))
        {
            ...
            if(losowanie==7)
                __Z__DELETE(x,y);
            masked_blit( tmp_czyszczenie, screen, 0, 0, x, y, tmp_czyszczenie->w, tmp_czyszczenie->h );
            masked_blit( tmp_rysowanie, screen, 0, 0, x+=27, y, tmp_rysowanie->w, tmp_rysowanie->h ); /// +54x  +54y
            if(losowanie==1)
                __I__(x,y);
            if(losowanie==2)
                __T__(x,y);
...
void Tablica::poruszanie1(BITMAP * tmp_czyszczenie, BITMAP * tmp_rysowanie)      //Poruszanie siê kszta³tami po planszy
{
    if(key[KEY_RIGHT])
    {
        kolizje(x,y);
        if(x<=tmp_x_R && (   (losowanie==1 && f_I_1_P==false) || (losowanie==2 && f_T_1_P==false) || (losowanie==2 && f_T_2_P==false) || (losowanie==2 && f_T_3_P==false) || (losowanie==3 && f_L_1_P==false) ||
                             (losowanie==3 && f_L_1_P==false) || (losowanie==3 && f_L_2_P==false) || (losowanie==3 && f_L_3_P==false) || (losowanie==4 && f_J_1_P==false) || (losowanie==4 && f_J_2_P==false) ||
                             (losowanie==4 && f_J_3_P==false) || (losowanie==6 && f_S_1_P==false) || (losowanie==6 && f_Z_1_P==false)
                         )
           ){
            if(losowanie==1)
            {
    ...
    {
        kolizje(x,y);
        if(x>=tmp_x_L && (   (losowanie==1 && f_I_1_L==false) || (losowanie==2 && f_T_1_L==false) || (losowanie==2 && f_T_2_L==false) || (losowanie==2 && f_T_3_L==false) || (losowanie==3 && f_L_1_L==false) ||
                             (losowanie==3 && f_L_1_L==false) || (losowanie==3 && f_L_2_L==false) || (losowanie==3 && f_L_3_L==false) || (losowanie==4 && f_J_1_L==false) || (losowanie==4 && f_J_2_L==false) ||
                             (losowanie==4 && f_J_3_L==false) || (losowanie==6 && f_S_1_L==false) || (losowanie==6 && f_Z_1_L==false)
                         )
           ){
            if(losowanie==1)
            {
    ...
    {
        kolizje(x,y);
        if(y<tmp_y && (      (losowanie==1 && f_I_1_D==false) || (losowanie==2 && f_T_1_D==false) || (losowanie==2 && f_T_2_D==false) || (losowanie==2 && f_T_3_D==false) || (losowanie==3 && f_L_1_D==false) ||
                             (losowanie==3 && f_L_1_D==false) || (losowanie==3 && f_L_2_D==false) || (losowanie==3 && f_L_3_D==false) || (losowanie==4 && f_J_1_D==false) || (losowanie==4 && f_J_2_D==false) ||
                             (losowanie==4 && f_J_3_D==false) || (losowanie==6 && f_S_1_D==false) || (losowanie==6 && f_Z_1_D==false)
                      )
           ){
            if(losowanie==1)
            {
...
void Tablica::__S_1_(int x, int y)
{
    plansza[konwerter_pola(x,y)-1]=1;
    plansza[konwerter_pola(x,y)+14]=1;
    plansza[konwerter_pola(x,y)+15]=1;
...
void Tablica::__S_1_DELETE(int x, int y)
{
    plansza[konwerter_pola(x,y)-1]=0;
    plansza[konwerter_pola(x,y)+14]=0;
    plansza[konwerter_pola(x,y)+15]=0;
...
void Tablica::__Z_1_(int x, int y)
{
    plansza[konwerter_pola(x,y)]=1;
    plansza[konwerter_pola(x,y)+15]=1;
    plansza[konwerter_pola(x,y)+14]=1;
...
void Tablica::__Z_1_DELETE(int x, int y)
{
    plansza[konwerter_pola(x,y)]=0;
    plansza[konwerter_pola(x,y)+15]=0;
    plansza[konwerter_pola(x,y)+14]=0;
...
void Tablica::__I_1_(int x, int y)
{
    plansza[konwerter_pola(x,y)-1]=1;
    plansza[konwerter_pola(x,y)]=1;
    plansza[konwerter_pola(x,y)+1]=1;
    plansza[konwerter_pola(x,y)+2]=1;
    //wyswietl_tablice();
    //cout<<konwerter_pola(x,y)<<"\n";
}
...
void Tablica::__I_1_DELETE(int x, int y)
{
    plansza[konwerter_pola(x,y)-1]=0;
    plansza[konwerter_pola(x,y)]=0;
    plansza[konwerter_pola(x,y)+1]=0;
    plansza[konwerter_pola(x,y)+2]=0;
}
...
void Tablica::__L_1_(int x, int y)
{
    plansza[konwerter_pola(x,y)-1]=1;
    plansza[konwerter_pola(x,y)]=1;
    plansza[konwerter_pola(x,y)+1]=1;
...
void Tablica::__L_2_(int x, int y)
{
    plansza[konwerter_pola(x,y)-1]=1;
    plansza[konwerter_pola(x,y)]=1;
    plansza[konwerter_pola(x,y)+15]=1;
...
void Tablica::__L_3_(int x, int y)
{
    plansza[konwerter_pola(x,y)+1]=1;
    plansza[konwerter_pola(x,y)+14]=1;
    plansza[konwerter_pola(x,y)+15]=1;
...
void Tablica::__L_1_DELETE(int x, int y)
{
    plansza[konwerter_pola(x,y)-1]=0;
    plansza[konwerter_pola(x,y)]=0;
    plansza[konwerter_pola(x,y)+1]=0;
...
void Tablica::__L_2_DELETE(int x, int y)
{
    plansza[konwerter_pola(x,y)-1]=0;
    plansza[konwerter_pola(x,y)]=0;
    plansza[konwerter_pola(x,y)+15]=0;
...
void Tablica::__L_3_DELETE(int x, int y)
{
    plansza[konwerter_pola(x,y)+1]=0;
    plansza[konwerter_pola(x,y)+14]=0;
    plansza[konwerter_pola(x,y)+15]=0;
...
void Tablica::__T_1_(int x, int y)
{
    plansza[konwerter_pola(x,y)]=1;
    plansza[konwerter_pola(x,y)+14]=1;
    plansza[konwerter_pola(x,y)+15]=1;
...
void Tablica::__T_2_(int x, int y)
{
    plansza[konwerter_pola(x,y)]=1;
    plansza[konwerter_pola(x,y)+14]=1;
    plansza[konwerter_pola(x,y)+15]=1;
...
void Tablica::__T_3_(int x, int y)
{
    plansza[konwerter_pola(x,y)-1]=1;
    plansza[konwerter_pola(x,y)+14]=1;
    plansza[konwerter_pola(x,y)+15]=1;
...
void Tablica::__T_1_DELETE(int x, int y)
{
    plansza[konwerter_pola(x,y)]=0;
    plansza[konwerter_pola(x,y)+14]=0;
    plansza[konwerter_pola(x,y)+15]=0;
...
void Tablica::__T_2_DELETE(int x, int y)
{
    plansza[konwerter_pola(x,y)]=0;
    plansza[konwerter_pola(x,y)+14]=0;
    plansza[konwerter_pola(x,y)+15]=0;
...
void Tablica::__T_3_DELETE(int x, int y)
{
    plansza[konwerter_pola(x,y)-1]=0;
    plansza[konwerter_pola(x,y)+14]=0;
    plansza[konwerter_pola(x,y)+15]=0;
...
void Tablica::__J_1_(int x, int y)
{
    plansza[konwerter_pola(x,y)-1]=1;
    plansza[konwerter_pola(x,y)+14]=1;
    plansza[konwerter_pola(x,y)+15]=1;
...
void Tablica::__J_2_(int x, int y)
{
    plansza[konwerter_pola(x,y)-1]=1;
    plansza[konwerter_pola(x,y)]=1;
    plansza[konwerter_pola(x,y)+14]=1;
...
void Tablica::__J_3_(int x, int y)
{
    plansza[konwerter_pola(x,y)-1]=1;
    plansza[konwerter_pola(x,y)]=1;
    plansza[konwerter_pola(x,y)+1]=1;
...
void Tablica::__J_1_DELETE(int x, int y)
{
    plansza[konwerter_pola(x,y)-1]=0;
    plansza[konwerter_pola(x,y)+14]=0;
    plansza[konwerter_pola(x,y)+15]=0;
...
void Tablica::__J_2_DELETE(int x, int y)
{
    plansza[konwerter_pola(x,y)-1]=0;
    plansza[konwerter_pola(x,y)]=0;
    plansza[konwerter_pola(x,y)+14]=0;
...
void Tablica::__J_3_DELETE(int x, int y)
{
    plansza[konwerter_pola(x,y)-1]=0;
    plansza[konwerter_pola(x,y)]=0;
    plansza[konwerter_pola(x,y)+1]=0;
...
void Tablica::kolizje(int x,int y)
{
    ...
    if( plansza[konwerter_pola(x,y)-2]==0 && plansza[konwerter_pola(x,y)+13]==0  && plansza[konwerter_pola(x,y)+29]==0 )
        f_S_1_L=false;
    else
        f_S_1_L=true;
    ...
    if( plansza[konwerter_pola(x,y)-1]==0 && plansza[konwerter_pola(x,y)+13]==0 && plansza[konwerter_pola(x,y)+28]==0 )
        f_Z_1_L=false;
    else
        f_Z_1_L=true;
    ...
    if( plansza[konwerter_pola(x,y)-2]==0 )
        f_I_1_L=false;
    else
        f_I_1_L=true;
    ...
    if( plansza[konwerter_pola(x,y)-2]==0 && plansza[konwerter_pola(x,y)+14]==0 && plansza[konwerter_pola(x,y)+29]==0)
        f_L_2_L=false;
    else
        f_L_2_L=true;

    if( plansza[konwerter_pola(x,y)]==0 && plansza[konwerter_pola(x,y)+13]==0 )
        f_L_3_L=false;
    else
        f_L_3_L=true;
    ...
    if( plansza[konwerter_pola(x,y)-1]==0 && plansza[konwerter_pola(x,y)+13]==0 && plansza[konwerter_pola(x,y)+29]==0 )
        f_T_1_L=false;
    else
        f_T_1_L=true;
    ...
    if( plansza[konwerter_pola(x,y)-2]==0 && plansza[konwerter_pola(x,y)+15]==0 )
        f_J_3_L=false;
    else
        f_J_3_L=true;
    ...
    if( plansza[konwerter_pola(x,y)]==0 && plansza[konwerter_pola(x,y)+16]==0 && plansza[konwerter_pola(x,y)+31]==0 )
        f_S_1_P=false;
    else
        f_S_1_P=true;
    ...
    if( plansza[konwerter_pola(x,y)+1]==0 && plansza[konwerter_pola(x,y)+16]==0 && plansza[konwerter_pola(x,y)+30]==0)
        f_Z_1_P=false;
    else
        f_Z_1_P=true;
    ...
    if( plansza[konwerter_pola(x,y)+3]==0 )
        f_I_1_P=false;
    else
        f_I_1_P=true;
    ...
    if( plansza[konwerter_pola(x,y)+2]==0 && plansza[konwerter_pola(x,y)+17]==0 )
        f_L_3_P=false;
    else
        f_L_3_P=true;
    ...
    if( plansza[konwerter_pola(x,y)]==0 && plansza[konwerter_pola(x,y)+16]==0 && plansza[konwerter_pola(x,y)+30]==0 )
        f_T_3_P=false;
    else
        f_T_3_P=true;
    ...
    if( plansza[konwerter_pola(x,y)]==0 && plansza[konwerter_pola(x,y)+17]==0 )
        f_J_1_P=false;
    else
        f_J_1_P=true;

    if( plansza[konwerter_pola(x,y)+1]==0 && plansza[konwerter_pola(x,y)+15]==0 && plansza[konwerter_pola(x,y)+30]==0 )
        f_J_2_P=false;
    else
        f_J_2_P=true;
    ...
    if( plansza[konwerter_pola(x,y)+29]==0 && plansza[konwerter_pola(x,y)+45]==0)
        f_S_1_D=false;
    else
        f_S_1_D=true;
    ...
    if( plansza[konwerter_pola(x,y)+30]==0 && plansza[konwerter_pola(x,y)+44]==0)
        f_Z_1_D=false;
    else
        f_Z_1_D=true;
    ...
    if( plansza[konwerter_pola(x,y)+14]==0 && plansza[konwerter_pola(x,y)+15]==0 && plansza[konwerter_pola(x,y)+16]==0 && plansza[konwerter_pola(x,y)+17]==0 )
        f_I_1_D=false;
    else
        f_I_1_D=true;
    ...
    if( plansza[konwerter_pola(x,y)+15]==0 && plansza[konwerter_pola(x,y)+16]==0 && plansza[konwerter_pola(x,y)+29]==0 )
        f_L_1_D=false;
    else
        f_L_1_D=true;

    if( plansza[konwerter_pola(x,y)+14]==0 && plansza[konwerter_pola(x,y)+45]==0 )
        f_L_2_D=false;
    else
        f_L_2_D=true;

    if( plansza[konwerter_pola(x,y)+29]==0 && plansza[konwerter_pola(x,y)+30]==0 && plansza[konwerter_pola(x,y)+31]==0 )
        f_L_3_D=false;
    else
        f_L_3_D=true;
    ...
    if( plansza[konwerter_pola(x,y)+15]==0 && plansza[konwerter_pola(x,y)+44]==0 )
        f_J_2_D=false;
    else
        f_J_2_D=true;

    if( plansza[konwerter_pola(x,y)+14]==0 && plansza[konwerter_pola(x,y)+15]==0 && plansza[konwerter_pola(x,y)+31]==0 )
        f_J_3_D=false;
    else
        f_J_3_D=true;
